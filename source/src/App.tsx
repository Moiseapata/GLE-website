  ...
  return (
    <div className="page-shell noise">
      ...
      <section id="journal" className="section-pad bg-[hsl(var(--secondary))]"><div className="section-wrap"><div className="flex items-end justify-between gap-5"><div><p className="eyebrow mb-4">{t.journal.eyebrow}</p><h2 className="display text-5xl leading-[.95] tracking-[-.05em] text-[hsl(var(--primary))] md:text-6xl">{t.journal.titleLine1}<br /><span className="text-[hsl(var(--accent))]">{t.journal.titleLine2}</span></h2></div><button className="btn-secondary hidden md:inline-flex" onClick={() => scrollToId('newsletter')} data-testid="button-journal-newsletter">{t.journal.newsletterCta} <Mail size={15} /></button></div><div className="mt-12 grid gap-6 md:grid-cols-[1.18fr_.82fr_.82fr]"><article className="group overflow-hidden rounded-2xl bg-[hsl(var(--background))]"><div className="image-frame aspect-[1.55]"><img src="/images/gle-solibra-plantation.jpg" alt="Plantation suivie avec les élèves lors du partenariat SOLIBRA" data-testid="img-journal-plot" /></div><div className="p-6"><div className="flex items-center gap-2 text-xs text-[hsl(var(--muted-foreground))]"><CalendarDays size={14} /> {t.journal.story1.date}</div><h3 className="display mt-4 text-3xl leading-tight text-[hsl(var(--primary))]">{t.journal.story1.title}</h3><p className="mt-3 text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">{t.journal.story1.text}</p><button className="mt-5 inline-flex items-center gap-2 text-xs font-bold text-[hsl(var(--primary))]" onClick={() => scrollToId('contact')} data-testid="button-read-story">{t.journal.story1.cta} <ArrowUpRight size={14} /></button></div></article><article className="rounded-2xl bg-[hsl(var(--primary))] p-6 text-[hsl(var(--primary-foreground))]"><span className="eyebrow !text-[hsl(var(--accent))]">{t.journal.methodLabel}</span><h3 className="display mt-12 text-3xl leading-tight">{t.journal.survivalNote}</h3><p className="mt-5 text-sm leading-relaxed text-[hsl(var(--primary-foreground)/.62)]">{t.journal.survivalBody}</p></article><article className="rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--background))] p-6"><span className="eyebrow">{t.journal.story3.eyebrow}</span><h3 className="display mt-16 text-3xl leading-tight text-[hsl(var(--primary))]">{t.journal.story3.title}</h3><p className="mt-4 text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">{t.journal.story3.text}</p><button className="mt-6 inline-flex items-center gap-2 text-xs font-bold text-[hsl(var(--primary))]" onClick={() => scrollToId('contact')} data-testid="button-download-guide">{t.journal.story3.cta} <ExternalLink size={14} /></button></article></div></div></section>
        ...
        <section id="methode" className="section-pad bg-[hsl(var(--background))]"><div className="section-wrap"><div className="mx-auto max-w-[640px] text-center"><p className="eyebrow mb-4 justify-center">{t.graine.eyebrow}</p><h2 className="display text-5xl leading-[.96] tracking-[-.05em] text-[hsl(var(--primary))] md:text-6xl">{t.graine.titleLine1}<br /><span className="text-[hsl(var(--accent))]">{t.graine.titleLine2}</span></h2><p className="mt-6 leading-relaxed text-[hsl(var(--muted-foreground))]">{t.graine.body}</p></div><div className="mt-12 flex flex-wrap items-center justify-center gap-3">{t.graine.steps.map((step, index) => <div className="flex items-center gap-3" key={step}><span className="rounded-full border border-[hsl(var(--border))] bg-[hsl(var(--card))] px-4 py-2 text-xs font-bold uppercase tracking-[.08em] text-[hsl(var(--primary))]">{step}</span>{index < t.graine.steps.length - 1 && <ArrowDownRight className="hidden text-[hsl(var(--accent))] sm:block" size={16} />}</div>)}</div></div></section>
      ...
      <section id="engagement" className="section-pad bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]"><div className="section-wrap"><p className="eyebrow mb-4 !text-[hsl(var(--accent))]">{t.commitments.eyebrow}</p><h2 className="display max-w-[620px] text-4xl leading-[.97] tracking-[-.05em] md:text-5xl">{t.commitments.title}</h2><div className="mt-10 grid gap-6 md:grid-cols-2"><div className="rounded-2xl bg-[hsl(var(--primary-foreground)/.08)] p-6 md:p-8"><h3 className="display text-2xl text-[hsl(var(--accent))]">{t.commitments.weDoTitle}</h3><ul className="mt-5 flex flex-col gap-3">{t.commitments.weDo.map((item) => <li className="flex items-start gap-3 text-sm leading-relaxed text-[hsl(var(--primary-foreground)/.82)]" key={item}><Check size={16} className="mt-0.5 shrink-0 text-[hsl(var(--accent))]" />{item}</li>)}</ul></div><div className="rounded-2xl border border-[hsl(var(--primary-foreground)/.16)] p-6 md:p-8"><h3 className="display text-2xl">{t.commitments.weDoNotTitle}</h3><ul className="mt-5 flex flex-col gap-3">{t.commitments.weDoNot.map((item) => <li className="flex items-start gap-3 text-sm leading-relaxed text-[hsl(var(--primary-foreground)/.7)]" key={item}><X size={16} className="mt-0.5 shrink-0 text-[hsl(var(--primary-foreground)/.5)]" />{item}</li>)}</ul></div></div></div></section>
